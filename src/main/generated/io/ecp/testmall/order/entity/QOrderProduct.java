...
public class QOrderProduct extends EntityPathBase<OrderProduct> {
    ...
    private static final long serialVersionUID = -189547832L;
    ...
    public QOrderProduct(Class<? extends OrderProduct> type, PathMetadata metadata, PathInits inits) {
        ...
        this.product = inits.isInitialized("product") ? new io.ecp.testmall.product.entity.QProduct(forProperty("product"), inits.get("product")) : null;
    }
